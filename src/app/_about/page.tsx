...
export const metadata: Metadata = {
  title: 'About',
  description:
    'I’m João Vitor. I live in Brazil, where I build amazing web experiences.',
}
      ...
      <div className="grid grid-cols-1 gap-y-16 lg:grid-cols-2 lg:grid-rows-[auto_1fr] lg:gap-y-12">
        ...
        <div className="lg:order-first lg:row-span-2">
          <h1 className="text-4xl font-bold tracking-tight text-zinc-800 sm:text-5xl dark:text-zinc-100">
            I’m João Vitor. I live in Brazil, where I build amazing web
            experiences.
          </h1>
        ...
        <div className="lg:pl-20">
          <ul role="list">
            ...
            <SocialLink
              href="https://linkedin.com/in/jvzaniolo/"
              icon={LinkedInIcon}
              className="mt-4"
            >
            ...
            <SocialLink
              href="mailto:jv.zaniolo@gmail.com"
              icon={MailIcon}
